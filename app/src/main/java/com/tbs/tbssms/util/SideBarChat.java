...
public class SideBarChat extends View {

	public static int m_nItemHeight = 22;// 字母 之间的间距
	...
	public SideBarChat(Context context) {
		super(context);
		init();
	}

	public SideBarChat(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public SideBarChat(Context context, AttributeSet attrs, int defStyle) {
