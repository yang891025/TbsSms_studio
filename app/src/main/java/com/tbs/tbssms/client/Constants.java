...
public class Constants {
    ...
    public static final String SHARED_PREFERENCE_NAME = "client_preferences2";
    public static final String SHARED_PREFERENCE_LAUNCHPATH = "/data/data/com.tbs.tbssms/shared_prefs/client_preferences2.xml";
