...
public class Notifier {
    ...
    public void notify(String notificationId, String apiKey, String title, String message, String uri) {
        ...
        if (isNotificationEnabled()) {
			...
			// } else {
			// String callbackActivityPackageName = sharedPrefs.getString(Constants.CALLBACK_ACTIVITY_PACKAGE_NAME, "");
			// String callbackActivityClassName = sharedPrefs.getString(Constants.CALLBACK_ACTIVITY_CLASS_NAME, "");
			...
			// Intent(Constants.ACTION_NOTIFICATION_CLICKED);
			...
			// positiveIntent.setData(Uri.parse((new
			// StringBuilder("notif://notification.adroidpn.org/")).append(apiKey).append("/").append(System.currentTimeMillis()).toString()));
			// PendingIntent clickPendingIntent =
			// PendingIntent.getBroadcast(context, 0, clickIntent, 0);
			// notification.setLatestEventInfo(context, title,
			// message,clickPendingIntent);
