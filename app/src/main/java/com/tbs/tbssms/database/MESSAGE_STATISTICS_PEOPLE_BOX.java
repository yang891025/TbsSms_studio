...
public interface MESSAGE_STATISTICS_PEOPLE_BOX extends BaseColumns {

	String TABLE_NAME = "MessageStatisticsPeopleBox";// 表名
	String NAME = "name";// 联系人姓名
	...
	String CREATE_TABLE = "create table " + TABLE_NAME + "(" + _ID
			+ " integer primary key autoincrement," + NAME + " text," + PHONE
			+ " text," + SENDCOUNT + " text," + RECEIVECOUNT + " text," + TIME
