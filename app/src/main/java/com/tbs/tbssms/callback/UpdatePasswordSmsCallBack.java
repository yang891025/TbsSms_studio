...
public class UpdatePasswordSmsCallBack extends HttpCallback {

	private static final String TAG = "UpdatePasswordSmsCallBack";
	...
	protected void onPostExecute(Integer integer) {
		...
		if(result){
			notifyResult = wenziUtil.QtoB(m_iniFileIO.getIniString(Constants.EXTERNALPATH + Constants.INIURL, Constants.SMSGATEWAYSMSCONTENT, Constants.XGSUCCESSSMSCONTENT, "", (byte) 0));
		}else{
			notifyResult = wenziUtil.QtoB(m_iniFileIO.getIniString(Constants.EXTERNALPATH + Constants.INIURL, Constants.SMSGATEWAYSMSCONTENT, Constants.XGUNSUCCESSSMSCONTENT, "", (byte) 0));
		}
		Log.d(TAG, "UpdatePasswordSmsCallBack notifyResult:"+notifyResult);
